  ...
  const allSections: GuideSection[] = [
    ...
    },
    {
      ...
      blocks: [
        ...
        { title: "查看結果", items: ["按下「開始探索」後，查看重複號碼統計與探索結果。", "結果顯示位置、號碼、結果期、連準次數、結果及版路類型。", "可使用同碼與連準篩選，並展開每條版路查看驗證過程。"] },
      ],
    },
    {
      title: "Matrix 天衡",
      ...
      blocks: [
        ...
        { title: "進階天衡設定", items: ["號碼順序：可選依號碼由小到大排序或依實際開獎順序排序；天天樂使用由小到大排序的資料。", "天衡日期：可選本日 (最新)、昨日 (上1期)、前日 (上2期)。", "標準範圍包含上1～7期、當期及當期之後至結果期前一期的參考球位；完整範圍向上擴大至14期，皆不包含結果期。", "十三期與完整範圍依目前帳號權限開放。"] },
        { title: "查看結果", items: ["按下「開始天衡」後，查看重複號碼統計與天衡結果。", "結果顯示兩個條件球位、對應號碼、結果期、連準次數、結果及版路類型。", "「結果期」以該組來源期為基準，顯示相隔多少期；「連準次數」表示連續通過驗證的歷史條件組數。", "可使用同碼與連準篩選，或點選重複號碼統計中的號碼篩選版路；展開版路可查看驗證過程與版路結果。"] },
      ],
    },
    {
      title: "Matrix 天衍",
      ...
      blocks: [
        ...
        { title: "查看結果", items: ["按下「開始天衍」後顯示符合條件的版路結果。", "可使用連準篩選，並展開版路查看驗證過程。"] },
      ],
    },
    {
      title: "Matrix 天工",
      ...
      blocks: [
        { title: "探索設定", items: ["彩種：今彩539、天天樂、六合彩、大樂透。", "天工期數：五十期。", "流程固定為二段式。", "命中條件固定為準2進3。"] },
        { title: "定位版路", items: ["定位版路不使用鎖定條件；探索、第一段與第二段各使用1個球位路徑。", "第一段驗證3個球位；第二段驗證前2個球位，第3個球位產生結果。"] },
        { title: "球位與版路", items: ["探索球位、第一段球位與第二段球位可選固定、依序遞增或依序遞減。", "第一段與第二段的版路類型皆可選加減版路或合值版路。"] },
        { title: "查看結果", items: ["按下「開始天工」後顯示間距期數、結果位置、結果及版路類型。", "可展開版路查看驗證過程。"] },
      ],
    },
    {
      title: "Matrix 狀態",
