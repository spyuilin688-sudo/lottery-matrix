...
export function FeaturePageRouter({
  ...
  if (screen === "tianheng") return <MatrixExplorePage key="tianheng" onNavigate={onNavigate} title="Matrix 天衡" />;
  if (screen === "tianshu") return <MatrixExplorePage key="tianshu" onNavigate={onNavigate} title="Matrix 天樞" />;
