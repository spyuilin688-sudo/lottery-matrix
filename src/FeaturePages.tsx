  ...
  const sections: GuideSection[] = [
    ...
    },
    {
      ...
      blocks: [
        ...
        { title: "近十三期：今彩539、天天樂", items: ["今彩539：依號碼由小到大排序65個；依實際開獎順序排序65個鎖定條件。", "天天樂：依號碼由小到大排序65個鎖定條件。", "加減版路驗證球位：74、79、84、89、94、99、104、109、114、119、124、129、134；每種排序合計6,760個。", "合值版路驗證球位：74、79、84、89、94、99、104、109、114、119、124、129、134；每種排序合計6,760個。", "拖牌版路驗證球位：每個鎖定條件使用自身換算；每種排序合計65個。", "今彩539兩種排序合計27,170個比對球位；天天樂合計13,585個。"] },
        { title: "近十三期：六合彩、大樂透", items: ["六合彩、大樂透：依號碼由小到大排序91個；依實際開獎順序排序91個鎖定條件。", "加減版路驗證球位：104、111、118、125、132、139、146、153、160、167、174、181、188；每種排序合計13,286個。", "合值版路驗證球位：104、111、118、125、132、139、146、153、160、167、174、181、188；每種排序合計13,286個。", "拖牌版路驗證球位：每個鎖定條件使用自身換算；每種排序合計91個。", "六合彩兩種排序合計53,326個比對球位；大樂透兩種排序合計53,326個比對球位。", "四彩種近十三期合計147,407個比對球位。"] },
