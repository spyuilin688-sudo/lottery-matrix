Warning: truncated output (original token count: 55332)
              ...
              {visibleResults.map((item) => (
                <article key={item.id}>
                  <div className="road-result-row">
                    ...
                    >
                      <span>{item.algorithmType.endsWith("版路") ? item.algorithmType : `${item.algorithmT…25332 tokens truncated…tton type="button" className="panel note-card" onClick={() => setSelectedNote(note.id)} key={note.id}>
