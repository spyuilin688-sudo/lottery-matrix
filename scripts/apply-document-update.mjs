...
feature = replaceAllExact(feature, '/assets/notifications/card.png', '/resources/notify-card.png', 'notification card icon');
feature = replaceAllExact(feature, '/assets/notifications/collision.png', '/resources/notify-collision.png', 'notification collision icon');
feature = replaceAllExact(feature, '/assets/notifications/expiry.png', '/resources/notify-expiry.png', 'notification expiry icon');
feature = replaceAllExact(feature, '/assets/notifications/system.png', '/resources/notify-system.png', 'notification system icon');
