...
describe('Matrix status route', () => {
  ...
  it('keeps seven-period road details locked for anonymous visitors on Friday without LINE auth', async () => {
    let authCalls = 0;
  ...
  it('returns validation for a visible seven-period road to an authenticated free member on Friday', async () => {
