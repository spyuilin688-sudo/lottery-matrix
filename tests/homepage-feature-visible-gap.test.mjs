...
test("five homepage feature cards keep 8px outer margins and responsive 2–2.5px gaps", () => {
  ...
  assert.match(layout, /--home-feature-inline:\s*8px;/);
  assert.match(layout, /--home-feature-gap:\s*clamp\(2px,\s*\.64vw,\s*2\.5px\);/);
