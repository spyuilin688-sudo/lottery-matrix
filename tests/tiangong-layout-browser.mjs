...
await writeFile(resolve(dir,'entry.tsx'),`import "/src/feature-pages.css";\n${imports}\nimport React from 'react';import{createRoot}from'react-dom/client';import{AppDialogProvider}from'/src/dialog/AppDialog';import{MatrixTiangongPage}from'/src/features/MatrixTiangongPage';createRoot(document.getElementById('root')).render(<AppDialogProvider><MatrixTiangongPage onNavigate={()=>{}}/></AppDialogProvider>);`);
