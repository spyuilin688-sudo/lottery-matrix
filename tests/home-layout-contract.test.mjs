...
test('homepage announcement sits below the logo as a compact non-interactive marquee', () => {
  ...
  assertBlock(css, '.home-screen .home-announcement-track[data-marquee-ready="true"]', /animation:\s*home-announcement-marquee var\(--home-announcement-duration\) linear 1;/);
