...
test("every current PWA title resolves to one of the 31 retained WebP backgrounds", () => {
  ...
  assert.equal(backgrounds.has("自訂觸發條件"), false);
  assert.equal(assets.has('url("/assets/lottery/headers/status-settings.webp")'), false);
