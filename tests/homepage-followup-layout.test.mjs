...
test("首頁彩種以單層圓角框與Logo 透明度與淡金底表示選取", () => {
  ...
  assert.match(selected, /border-color:\s*color-mix\(in srgb, var\(--home-frame-bright\) 55%, transparent\);[^}]*background:\s*color-mix\(in srgb, var\(--home-frame-gold\) 6%, var\(--lottery-neutral-950\)\);/);
