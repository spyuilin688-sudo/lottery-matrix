...
test("首頁使用正式 MatrixLogo 圖檔並在正式框內以流式尺寸呈現", () => {
  assert.match(source, /logo:\s*"\/assets\/lottery\/functions\/MatrixLogo\.png"/);
  assert.match(source, /<header className="brand-header home-logo-box">\s*<div className="home-brand-frame">\s*<img className="home-logo-image" src=\{HOME_ASSETS\.logo\}/s);
