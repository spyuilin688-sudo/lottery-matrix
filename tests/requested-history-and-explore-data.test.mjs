...
test("探索只使用 Canonical Python scoped final rows 與固定來源距離，舊演算法已淘汰", () => {
  ...
  // The v15 worker is independently covered by test_worker.py and the v15 publication migration.
  assert.match(workerSource, /ANALYSIS_VERSION = "matrix-python-v15"/);
