...
async function fixture({ retire = true } = {}) {
 ...
 const original=read('20260829181807_matrix_result_rpc.sql');
 ...
 await db.exec(functionSql(read('20260914184931_confirmed_member_permission_fixes.sql'),'public.matrix_custom_status_reset'));
 await db.exec(read('20260904104229_add_matrix_watchdog_leases.sql'));
 await db.exec(read('20260916002923_watchdog_active_analysis_state.sql'));
 ...
 await db.exec(read('20260917171346_matrix_status_identity_get.sql'));
