-- Re-apply the Explore v11 list RPC ordering through a new forward migration.
-- The original v11 migration had already been applied before its fallback ordering was amended.
begin;
