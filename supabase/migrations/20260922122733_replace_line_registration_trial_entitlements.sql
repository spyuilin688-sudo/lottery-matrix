-- Replace the original LINE-registration Tianyan/Tiangong trials with a single
-- 48-hour higher-period/full-range benefit shared by Explore, Tianheng and Tianshu.
...
comment on column public.members.line_trial_started_at is
  'Server-recorded first LINE member registration: 48-hour Matrix Explore/Tianheng/Tianshu thirteen-period and full-range access. Existing members are not backfilled.';
