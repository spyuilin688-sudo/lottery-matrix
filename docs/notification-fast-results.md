...
所有通知內文日期均取自對應開獎資料的 `drawDate`，格式為 `MM/DD(星期)`。舊版狀態／牌單事件缺少日期時，只查詢它自己的彩種與期數，不使用發送日期。天天樂補算歷史期數時，不發送舊期通知。
...
- 開獎結果：`09/05(六) 今彩539 開獎號碼：03-08-10-28-38`
- 臨界：`09/05(六) 今彩539 發現了極為罕見的版路！`
- 共振：`09/05(六) 今彩539 發現了具備強烈共振效應的版路！`
- 聚合：`09/05(六) 今彩539 發現了具備明顯規律集中性的版路！`
- 啟動：`09/05(六) 今彩539 發現了具備基本參考價值的版路！`
- 牌單：`09/05(六) 今彩539 最新的牌單已更新囉！`
