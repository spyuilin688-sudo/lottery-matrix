...
- 中午／下午固定檢查：12:00、14:00、16:00。
- 13 個六合彩選號提醒時段的前 15 分鐘：16:45、17:15、17:45、18:15、18:45、19:15、19:45、20:15、20:30、20:45、20:55、21:05、21:10。
- 週二、週四、週六執行完整檢查；週日以相同時段執行例外保險檢查。
- 週一、週三、週五各增加一次 23:00 保險檢查。
- 每個固定時段都會重新向香港賽馬會確認官方日曆；同一時段成功後不會重複抓取。
- 每次確認成功後，有效期會延續到「下一個排定檢查時段＋5 分鐘」；週一、週三、週五的下一個排定檢查包含當晚 23:00。涵蓋範圍外、錯過下一個排定檢查或尚未公告的新月份仍會待確認。
