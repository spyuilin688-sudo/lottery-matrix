...
export const apiStatusInventory: readonly ApiStatusDefinition[] = [
  ...
  { id: 'notification-calendar', name: '六合彩開獎日曆', group: '通知', location: 'Supabase', endpoint: '/rest/v1/rpc/notification_draw_calendar_status', checkMode: 'service', description: '依香港賽馬會官方日期決定選號提醒；週二、四、六固定檢查，週日保險檢查，日期待確認時暫停提醒。' },
