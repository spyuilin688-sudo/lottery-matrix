...
export const apiStatusInventory: readonly ApiStatusDefinition[] = [
  ...
  { id: 'native-notification-dispatch', name: '通知派送架構', group: '通知', location: 'Supabase', endpoint: '/rest/v1/rpc/admin_notification_delivery_health', checkMode: 'service', description: '驗證事件觸發、5 分鐘 Recovery，以及 Web／Native／管理員通知佇列與正式派送紀錄；不發送測試通知。' },
