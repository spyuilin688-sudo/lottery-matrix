...
- Notebook notes, records and settings persist together in one browser-local snapshot owned by the stable authenticated LINE account's Supabase user id. Tokens never identify the notebook. This does not provide cloud synchronization. Original unowned keys remain untouched and unassigned because their owner cannot be established.
