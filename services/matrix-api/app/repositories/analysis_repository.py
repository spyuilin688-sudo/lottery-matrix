...
class AnalysisRepository(Protocol):
    ...
    def has_tianheng_results(self, lottery: str, draw_period: str, analysis_version: str) -> bool: ...
...
class InMemoryAnalysisRepository:
    ...
    def has_tianheng_results(
        ...
        return any(key[:3] == (lottery, draw_period, analysis_version) for key in self.tianheng_results)
